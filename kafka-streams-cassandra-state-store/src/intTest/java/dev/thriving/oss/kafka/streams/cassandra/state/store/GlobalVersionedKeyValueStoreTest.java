...
class GlobalVersionedKeyValueStoreTest extends AbstractIntegrationTest {

    private static final Logger LOG = LoggerFactory.getLogger(GlobalVersionedKeyValueStoreTest.class);
                ...
                .toTable(
                    Materialized.<String, Long>as(
                                    ...
                                    CassandraStores.builder(session, STORE_NAME)
                                            .globalVersionedKeyValueStore(Duration.ofMillis(30)))
                            .withCachingDisabled()
                            .withLoggingDisabled()
