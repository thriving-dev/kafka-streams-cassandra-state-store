package dev.thriving.kafka.streams.cassandra.state.store.example.wordcount.cassandra311;
...
public final class WordCountDemo {
    ...
    static Properties getStreamsConfig() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "word-count-cassandra311");
